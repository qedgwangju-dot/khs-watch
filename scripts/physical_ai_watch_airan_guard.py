...
def _finalize_airan_criteria() -> None:
    ...
    new = '공식 사전예고·신규 AI 모델/성능 공개·천 단위 공급망 발주·공급업체 심사·수주·고객 실명·배치 발주·양산/출하·생산 수율·생산능력·현장 배치·관절·감속기·모터·인코더·힘/토크·촉각·비전 센서의 고객선정·수주·양산·수율·납기·가격 변화·대당 부품 탑재가치·배터리 소재 채택·촉각/데이터 사업화·AI-RAN Physical AI 실증·상용계약·기관 지분 변화처럼 돈 버는 능력·기술 재평가·수급·시간표를 바꾸는 내용만 알림.'
