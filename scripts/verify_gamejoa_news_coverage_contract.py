...
AUGUST10_CASES = (
    ...
    ("브이아이운용, 반도체·금융·지주 담은 ETF 11일 신규 상장", "신규 상장", "수급"),
    ("고려아연, 미국 핵심광물 프로젝트 모범사례 지목", "고려아연", "돈 버는 능력"),
    ("네이버, 앤트로픽에 첫 투자해 AI 협력 확대", "앤트로픽", "수급"),
    ("애플, CXMT 메모리칩 탑재 시험", "cxmt", "돈 버는 능력"),
    ("엔비디아와 월가, AI 데이터센터 금융플랫폼 구축", "금융플랫폼", "돈 버는 능력"),
    ("SK하이닉스, 키옥시아 CB 전환·의결권 확보 검토", "키옥시아", "시간표"),
    ("국내 ETF 자금 7000억원 유출, 순자산 감소", "etf", "수급"),
    ("신성이엔지, 태양광 모듈 신규 라인 가동·양산", "태양광 모듈", "돈 버는 능력"),
    ("TPG, 롯데렌탈 1조3000억원 인수 계약", "인수 계약", "수급"),
)
...
AUGUST21_CASES = (
    ...
    ("마이크론, 미국 메모리 전문연구소에 10년간 투자", "메모리 전문연구소", "돈 버는 능력"),
    ...
    ("테슬라, 머스크 CEO 보상 패키지 주식 부여가치·희석 조건 공시", "보상 패키지", "수급"),
