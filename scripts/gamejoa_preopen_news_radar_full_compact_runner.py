...
def enforce_semiconductor_cycle_contract() -> None:
    append_unique(base.QUERIES, [
        ...
        ("반도체 정책 드라이브", "semiconductor R&D tax credit tax deduction chip subsidy investment credit mater…61812 tokens truncated…length handling so one damaged snippet cannot
