...
SECTOR_RULES: list[tuple[str, list[str]]] = [
    ...
    ("국토/부동산/건설", ["국토부", "국토교통부", "주택공급", "부동산", "재개발", "재건축", "SOC", "철도", "공항", "건설정책", "건설업", "건설사", "교통", "인프라"]),
    ...
    ("재난안전/치안", ["행안부", "행정안전부", "재난", "재난안전", "국민안전", "사회안전", "치안", "경찰", "소방"]),
...
POLICY_COLOR_RULES: list[tuple[str, list[str]]] = [
    ...
    ("주택공급·SOC·건설 정책 색채", ["국토부", "주택공급", "부동산", "SOC", "철도", "공항", "건설정책", "건설업", "건설사", "재개발"]),
    ...
    ("재난안전·치안 색채", ["행안부", "재난", "재난안전", "국민안전", "사회안전", "치안", "경찰", "소방"]),
