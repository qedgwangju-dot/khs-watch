...
def _funding_guard_block() -> list[str]:
    return [
        ...
        "• 🟧 <b>WSJ 2026-09-10</b>: 이달 <b>20억달러 초과 초기 집행 가능성</b> 보도 → 실제 적용·별도 합의 여부 확인 필요",
        "• 🏛 <b>최신 확인 정부 공식상태</b>: 첫 송금 규모·시기 및 세부 투자내용은 아직 확정되지 않았다는 입장",
...
def _texas_ai_power_block() -> list[str]:
    return [
        ...
        "• ERCOT 2026-04 공식 기준: 신청 445.8GW 중 <b>321GW 연구 미제출</b>, <b>93.7GW 검토 중</b>, <b>22GW 요건 충족</b>",
        ...
        "",
        "<b>다음 확인</b>",
        "1) Encinal 정부 공식 확정  2) AI 고객 실명·PPA  3) 1.4GW 가스터빈 제조사  4) 4.9GW HRSG·스팀터빈 발주  5) 가스관·환경허가·착공·전원 인가",
    ]
...
def _alaska_lng_block() -> list[str]:
    return [
        ...
        "• 1단계: <b>739마일·42인치 가스관</b>, ConocoPhillips 30년 가스공급계약 확보",
