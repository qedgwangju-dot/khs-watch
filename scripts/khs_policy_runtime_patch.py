...
def patch_korea_presidential_personnel(text: str) -> str:
    ...
    text = replace_once(
        text,
        '("court_order", "final_rule", "sanctions_tariffs_export", "china_trade_controls", "energy_security_policy", "state_smr_moc_policy", "presidential_action", "fda_decision", "treasury_borrowing")',
        '("court_order", "final_rule", "sanctions_tariffs_export", "china_trade_controls", "energy_security_policy", "state_smr_moc_policy", "presidential_action", "korea_presidential_personnel", "fda_decision", "treasury_borrowing")',
    )
    text = replace_once(
        text,
        '("court_order", "final_rule", "permit_restart", "agency_order", "energy_security_policy", "state_smr_moc_policy", "presidential_action", "fcc_decision_notice")',
        '("court_order", "final_rule", "permit_restart", "agency_order", "energy_security_policy", "state_smr_moc_policy", "presidential_action", "korea_presidential_personnel", "fcc_decision_notice")',
    )
    text = replace_once(
        text,
    ...
    text = replace_once(
        text,
        '{"rss", "courtlistener", "kind_html", "federal_register_json", "whitehouse_html", "fcc_html", "state_html", "mofcom_html", "treasury_html"}',
        '{"rss", "courtlistener", "kind_html", "federal_register_json", "whitehouse_html", "korea_president_html", "fcc_html", "state_html", "mofcom_html", "treasury_html"}',
    )
    return text
